...
const StyledWrapper = styled.div`
 .tooltip-container {
  ...
  position: fixed; /* Correct position syntax */
  left: 5%;
  top: 50%;
  transform: translateY(-50%);
  padding: 16px; /* You already have padding defined twice, so remove the redundancy */
  background-color: #3498db; /* You don't need to add both background and background-color */
  color: white;
